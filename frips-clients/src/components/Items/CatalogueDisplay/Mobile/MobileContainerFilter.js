...
const MobileContainerFilter = ({
  ...
  }, [dispatch, displayProduct, pagination, filterLoading]);

  const renderedItems = useMemo(() => {
    return renderedItem(filterItem, classes, favorite, dispatch, history);
  }, [filterItem, items, displayProduct]);
...
export default connect(mapStateToProps)(MobileContainerFilter);
